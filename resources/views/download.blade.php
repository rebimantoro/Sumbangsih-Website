...
<div class="main">
    <div class="container">
        <div class="row header">
            <div class="col-md-12">
                <h1 style="font-family: gloss;">Sumbangsih<span class="blue-font"></span></h1>
            </div>
            <div class="col-md-12">
                <h4 class="title">Digitalisasi Bantuan Langsung Tunai Pemerintah</h4>
            </div>
        </div>

        <div class="row" style="margin: 20px;">
            <p>Sumbangsih memiliki arti berupa “bantuan (berupa pemberian karangan, uang dan sebagainya) sebagai tanda kasih”. Sumbangsih merupakan perwujudan tanda kasih dari pemerintah untuk rakyat Indonesia. Sumbangsih memiliki slogan “For The Better Indonesian Entrepreneur” yang berarti memberikan dukungan terhadap pemilik UMKM untuk terus bisa mengembangkan usaha yang dimiliki.</p>
            <h5>
        </div>

        <div class="row">
            <div class="col-md-12">
                <a href="#download"><button class=" btn btn-danger btn-block">Download Sekarang</button></a>
            </div>
        </div>
        ...
        <section id="download">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{asset('dn')}}/SAWIT_JAYA.apk"><button class=" btn btn-danger btn-block">Download Sekarang</button></a>
                </div>
            </div>
        </section>
...
<footer class="page-footer teal bg-danger">
    <div class="footer-copyright text-center py-3">
        <a href="#"> <br> <br>
            <span class="feylabs ">
                    <h1 style="font-family: gloss;">{{config('app.name')}}</h1>
                </span> </a>
    </div>
</footer>
