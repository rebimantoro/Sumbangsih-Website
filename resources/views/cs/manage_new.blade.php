...
@section('page-breadcrumb')
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Manage Chat</h4>
...
@section('page-wrapper')
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="mb-0 ">Manage Chat CS</h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="table_data" class="table table-hover table-bordered display no-wrap" style="width:100%">
                    ...
                    <tr>
                        ...
                        <th data-sortable="">Balas Chat</th>
                        <th data-sortable="">Kontak</th>
                        <th data-sortable="">Pesan Terakhir</th>
                    ...
                    @forelse ($datas as $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{url('/cs-chat'.'/'.$data->id.'/edit')}}">
                                    <button type="button" class="btn btn-primary">Balas Chat</button>
                                </a>
                            </td>
